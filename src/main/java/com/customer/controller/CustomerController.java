...
public class CustomerController {
    ...
    public ResponseEntity<CustomerResponse> findCustomerById(@PathVariable int id, Principal principal) {
    ...
    /* get the customer by Id */
    @GetMapping("/customer")
    public ResponseEntity<CustomerResponse> findCustomerById(@PathVariable int id) {
